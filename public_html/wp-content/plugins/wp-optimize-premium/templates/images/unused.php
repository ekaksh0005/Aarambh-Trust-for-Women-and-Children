...
<div class="wpo-unused-images-section">
	...
	<div class="wp-optimize-images-refresh-icon" style="float:right">
		<?php if (defined('WPO_IMAGES_TRASH') && WPO_IMAGES_TRASH) { ?>
	...
	<div id="wpo_unused_images_control_panel" class="wpo-fieldgroup">
		...
		<input type="button" id="wpo_remove_unused_images_btn" class="button button-large wpo-unused-images-el" value="<?php _e('Permanently remove selected images', 'wp-optimize'); ?>" />

		<input type="button" id="wpo_restore_unused_images_from_trash_btn" class="button button-primary button-large wpo-unused-images-trash-el" value="<?php _e('Restore selected images', 'wp-optimize'); ?>" />
		<?php } else { ?>
